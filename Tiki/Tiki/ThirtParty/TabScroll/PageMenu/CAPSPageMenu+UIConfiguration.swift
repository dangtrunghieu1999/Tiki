...
extension CAPSPageMenu {
    ...
    func setUpUserInterface() {
        let viewsDictionary = ["menuScrollView": menuScrollView,
                               "otherViewContainer": otherViewContainer,
        ...
        controllerScrollView.frame = CGRect(x: 0.0,
                                            y: otherViewHeight,
        ...
        menuScrollView.frame = CGRect(x: 0.0,
                                      y: 0.0,
                                      width: self.view.frame.width,
        ...
        let menuScrollView_constraint_H:Array = NSLayoutConstraint.constraints(
            withVisualFormat: "H:|[menuScrollView]|",
            options: NSLayoutConstraint.FormatOptions(rawValue: 0),
            metrics: nil,
            views: viewsDictionary)
        
        let menuScrollView_constraint_V:Array = NSLayoutConstraint.constraints(
            withVisualFormat: "V:[menuScrollView(\(configuration.menuHeight))]",
            options: NSLayoutConstraint.FormatOptions(rawValue: 0),
            metrics: nil,
            views: viewsDictionary)
        ...
        // Other View
        otherViewContainer.frame = CGRect(x: 0,
                                          y: configuration.menuHeight,
                                          width: view.frame.width,
                                          height: otherViewHeight)
        
        view.addSubview(otherViewContainer)
    ...
    func configureUserInterface() {
        ...
        let menuItemTapGestureRecognizer = UITapGestureRecognizer(
            target: self,
            action: #selector(CAPSPageMenu.handleMenuItemTap(_:))
        )
