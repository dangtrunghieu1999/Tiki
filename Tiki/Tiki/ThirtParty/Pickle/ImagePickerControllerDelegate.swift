...
public protocol ImagePickerControllerDelegate: UINavigationControllerDelegate {
    ...
    /// Optional. Tells the delegate that the user take photo
    @objc optional func imagePickerCpmtroller(_ picker: ImagePickerController, didTakePhoto photo: UIImage?)
}
